...
if __name__ == '__main__': #Call everything from here, deleted dose_amount
    ...
    weight_input = weight_input() #Return an array with the weight amount and the units
    weight = weight_parse(weight_input) #Will take the weight inputted, and then convert to kgs to and return the new weight
    dosage_mg_first_day = calculate_dosage(diagnosis, weight) #Will return the dosage that will be used on the first day
    dosage_output(weight, dosage_mg_first_day) #Will print out the dosage for the weight