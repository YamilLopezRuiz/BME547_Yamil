...
# in_file = open("input_data.txt", "r")  # If file is very big, just look for data you want
# for line in in_file:
#    print(line)
# first_fruit = in_file.readline()  # Reads only one line, but cannot move back up. 
# second_fruit = in_file.readline()  # Need to close file and reopen if you want to go up
